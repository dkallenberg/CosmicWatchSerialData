...
class SerialDataLogger:
    def __init__(self, root):
        ...
        self.p_default_filename = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S") + "_primary_data.txt"
        self.s_default_filename = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S") + "_secondary_data.txt"
