...
class SerialDataLogger:
    ...
    def create_gui(self):
        ...
        self.port1_dropdown = ttk.Combobox(port_frame, textvariable=self.port1, width=8)
        ...
        self.port2_dropdown = ttk.Combobox(port_frame, textvariable=self.port2, width=8)
        ...
        self.file1_entry = ttk.Entry(file_frame, textvariable=self.filename1, width=45)
        ...
        self.file2_entry = ttk.Entry(file_frame, textvariable=self.filename2, width=45)
